...
<b>Acknowledgement</b>: This markdown file has been borrowed directly from [CoOp official repository](https://github.com/KaiyangZhou/CoOp/blob/main/DATASETS.md).
