...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.MPL = CN()
    cfg.TRAINER.MPL.N_CTX = 2  # number of context vectors
    cfg.TRAINER.MPL.N_ADD_OP = 2 # number of added context vectors by add operation
    cfg.TRAINER.MPL.N_RM_OP = 1 # number of removed context vectors by remove operation
    cfg.TRAINER.MPL.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.MPL.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.MPL.PROMPT_DEPTH = 9 # Max 12, minimum 0, for 1 it will act as shallow MaPLe (J=1)
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
